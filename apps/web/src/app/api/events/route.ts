...
export async function GET(req: NextRequest) {
  try {
    ...
    console.error("Events GET endpoint error:", error);
    return apiError("INTERNAL_ERROR", "Failed to fetch events", null, 500);
  }
}
...
export async function POST(req: NextRequest) {
  try {
    ...
    console.error("Events POST endpoint error:", error);
    return apiError("INTERNAL_ERROR", "Failed to create event", null, 500);
  }
}
